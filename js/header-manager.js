    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            ...
            <div class="hidden md:flex items-center space-x-6 lg:space-x-8">
                <!-- 導航連結 - 根據當前頁面自動調整 -->
                <a href="https://judgai.com/saymind" class="nav-link text-gray-300 hover:text-cyan-400 font-medium transition-all duration-300" data-nav="home">首頁</a>
                <a href="https://judgai.com/saymind/changelog.html" class="nav-link text-gray-300 hover:text-cyan-400 font-medium transition-all duration-300" data-nav="changelog">更新日誌</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden border-t border-gray-700/50 pt-4 pb-4">
            <div class="flex flex-col space-y-3">
                <a href="https://judgai.com/saymind" class="nav-link text-gray-300 hover:text-cyan-400 font-medium transition-all duration-300 px-2 py-2" data-nav="home">首頁</a>
                <a href="https://judgai.com/saymind/changelog.html" class="nav-link text-gray-300 hover:text-cyan-400 font-medium transition-all duration-300 px-2 py-2" data-nav="changelog">更新日誌</a>
